...
class MultiDataPack extends StatefulWidget {
  MultiDataPack({Key key}) : super(key: key);

  @override
  _MultiDataPackState createState() => _MultiDataPackState();
}

class _MultiDataPackState extends State<MultiDataPack> {
                ...
                child: TextField(
                  ...
                  onSubmitted: (v) {
                    ...
                    setState(() {
                      ...
                      _price.clear();
                      if (_optimag == "assets/Mb/MPT.png") {
                        _price.add("MPT Night Time - 7 Nights 899Ks");
                      } else if (_optimag == "assets/Mb/Telenor.png") {
                        _price.add("Telenor Data Suboo 700 MB 799Ks");
                      } else if (_optimag == "assets/Mb/Ooredoo.png") {
